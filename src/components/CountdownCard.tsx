        ...
        <div className="overflow-hidden px-1 pb-1">
          ...
          >
            {confirmingDelete ? (
              <div className="flex h-11 items-center justify-between gap-2 bg-secondary px-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    title="Delete"
                    className="brut-thin brut-press flex h-8 w-8 items-center justify-center rounded-none bg-card"
                  >
                  ...
                  <button
                    ...
                    title="Cancel"
                    className="brut-thin brut-press flex h-8 w-8 items-center justify-center rounded-none bg-cream"
                  >
              ...
              <div className="brut-thin flex h-11 items-center justify-between gap-2 px-2" style={{ backgroundColor: PALETTE.teal }}>
              ...
              <div className="flex flex-nowrap gap-2">
                ...
                <button
                  ...
                  className={`brut-thin brut-press flex h-11 ${lapsed ? "flex-1" : "w-11 shrink-0"} items-center justify-center rounded-none bg-cream disabled:opacity-60`}
                >
                ...
                {lapsed && (
                  <button
                    ...
                    className="brut-thin brut-press flex h-11 flex-1 items-center justify-center rounded-none bg-cream"
                  >
                    {isArchived ? (
                ...
                <button
                  ...
                  aria-label="Delete countdown"
                  className={`brut-thin brut-press flex h-11 ${lapsed ? "flex-1" : "w-11 shrink-0"} items-center justify-center rounded-none bg-card`}
                >
