      ...
      <main className="view-page mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="brut mt-6 bg-card p-4 text-foreground sm:mt-8 sm:p-6">
          <p className="text-base leading-relaxed">
            ...
            <span className="font-bold">years from now</span> — there’s no ceiling. Everything ticks at
            once on one shared clock, down to the second, so you can watch time pass.
          </p>
          ...
          <p className="mt-4 text-base leading-relaxed">
            You don't need an account — clocks live in this browser until you want them elsewhere.
            Sign in and the same board follows you from one browser to the next. Open the tab, set a
            countdown, and put a clock on it.
          </p>
        </div>
