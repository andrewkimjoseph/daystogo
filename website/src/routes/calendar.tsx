  ...
  head: () => ({
    meta: [
      { title: "Calendar — Days To Go" },
      {
        name: "description",
        content:
          "Browse months and years in a playful brutalist calendar. Pick a day, then create a countdown in the app.",
      },
      { property: "og:title", content: "Calendar — Days To Go" },
      {
        property: "og:description",
        content: "Flip through months and years, see today, and open the app to put a clock on a day.",
      },
    ...
    <div className="min-h-screen">
      ...
      <main className="view-page mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <p className="mt-2 mb-6 max-w-xl font-bold text-muted-foreground">
          Wander through the months. Today is marked. Tap a day, then create a countdown in the app.
        </p>
